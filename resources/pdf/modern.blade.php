...
<html lang="fr"><head>
    ...
    <title>CV</title>
    <style>
        @import url('https://fonts.googleapis.com/css?family=Archivo|Inconsolata');
...
<div class="row no-gutters" id="main">
    <div class="col-3 py-5" id="sidebar">
            ...
            @if (count($resume->contents['skills'] ?? []))
                ...
                @foreach ($resume->contents['skills'] as $skill)
                    <div class="mb-2">
                        ...
                        <div class="mt-2" style="height: 2px; background-color: #aaa; width: 100%">
                            <div style="height: 2px; background-color: {{ $colors['primary'] }}; width: {{ $skill['level'] }}%">&nbsp;</div>
                        </div>
            ...
            @if (count($resume->contents['languages'] ?? []))
                ...
                @foreach ($resume->contents['languages'] as $language)
                    <div class="mb-2">
                        ...
                        <div class="mt-2" style="height: 2px; background-color: #aaa; width: 100%">
                            <div style="height: 2px; background-color: {{ $colors['primary'] }}; width: {{ $language['level'] }}%">&nbsp;</div>
                        </div>
