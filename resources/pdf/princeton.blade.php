...
<div class="row no-gutters" id="main">
    <div class="col">
        ...
        <h2 class="h4 text-uppercase">@lang('app.creator.labels.profile.section_title')</h2>

        <table>
            <tr><td style="width: 200px;" class="text-right pb-3">Nom</td><td class="pb-3 pl-4"><strong>{!! $resume->contents['basics']['name'] ?? '' !!}</strong></td></tr>
            <tr><td style="width: 200px;" class="text-right pb-3">Adresse</td><td class="pb-3 pl-4"><strong>{!! $resume->contents['basics']['location']['address'] ?? '' !!}, {!! $resume->contents['basics']['location']['postalCode'] ?? '' !!} {!! $resume->contents['basics']['location']['city'] ?? '' !!}</strong></td></tr>
            <tr><td style="width: 200px;" class="text-right pb-3">Numéro de téléphone</td><td class="pb-3 pl-4"><strong>{!! $resume->contents['basics']['phone'] ?? '' !!}</strong></td></tr>
            <tr><td style="width: 200px;" class="text-right pb-3">Adresse e-mail</td><td class="pb-3 pl-4"><strong>{!! $resume->contents['basics']['email'] ?? '' !!}</strong></td></tr>
